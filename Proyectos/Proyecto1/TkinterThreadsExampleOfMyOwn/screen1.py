...
#This function display the first window for the first time
def display():
    root = Tk() #Instantiate the top level window
    root.wm_title("First Window") #Add a title to the window
    firstWindow = FirstWindow(root) #Add the first window to the root
