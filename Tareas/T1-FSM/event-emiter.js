...
module.exports = (() => {
  ...
  class EventEmitter {
     ...
     * Aqui agrega la maquina de estados
     * La palabra listener hace referencia a la maquina de estados, la cual siempre está escuchando
     */
    register(listener) {
    ...
    _send(event) {      
      ...
      //  console.log("El mensaje enviado a todos los objetos es: " + event.msg);
